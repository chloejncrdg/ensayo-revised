...
export const editToolGroup = async (req, res) => {
    try {
        const { id } = req.params;
        const { title, unitId, moduleId, courseId, courseSectionId, image } = req.body;
        ...
        const archived = req.body.archived !== undefined ? req.body.archived : currentToolGroup.archived;
